<?php
  ...
  class Alumno{
    ...
    function VerificarAlumno($usuario,$contra){/*$sql = "select idalumno,alumnonombre,contrasena,rolalumno,stadoalumno from alumnowhere alumnonombre ='$usuario'";*/
    ...
    function listar_NotasCur($curso,$alum){
      $sql = "SELECT practica1, practica2, practica3, practica4, trabajo1, trabajo2, trabajo3, trabajo4, parcial1, 
      parcial2, parcial3, parcial4, exsamen1, exsamen2 FROM notas where alumnoid='$alum' and curso='$curso' ";
      $arreglo = array();
      if ($consulta = $this->conexion->conexion->query($sql)) {
        while ($consulta_VU = mysqli_fetch_array($consulta)) {
          $arreglo['data'][] = $consulta_VU;
