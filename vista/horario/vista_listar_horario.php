    ...
    <div class="box box-warning box-solid">
        <div class="box-header with-border">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-3">
                    <button class="btn btn-success" style="width:100%" onclick="cargar_contenido('contenido_principal','horario/vista_crear_horario.php')"><i class="glyphicon glyphicon-plus"></i>Nuevo Horario</button>
                </div>
            </div>
